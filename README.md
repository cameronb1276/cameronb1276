...
I like building software that solves real problems, can be maintained over time, and gives the owner control over the source code and infrastructure.

My work is focused around custom websites, web apps, internal dashboards, APIs, automation, and practical tools for business operations.
...
- **Website Builder Tooling** — custom site-building systems with editable settings, reusable components, and structured configuration.
...
- Creating maintainable systems where the client can own the code, data, and infrastructure.
...
Custom websites, web applications, AI tools, Cloudflare/server management, analytics, monitoring, and infrastructure support for businesses that want more ownership and flexibility.

<a href="https://sloansites.com">
  <img src="https://img.shields.io/badge/Visit-sloansites.com-2563EB?style=for-the-badge&logo=googlechrome&logoColor=white" alt="Visit SloanSites" />
</a>

### DetailedTM

A Rust-based desktop/system monitoring project focused on displaying processes, ports, resource usage, and system activity in a more detailed and useful way.

<a href="https://github.com/cameronb1276/DetailedTM">
  <img src="https://img.shields.io/badge/Repository-DetailedTM-181717?style=for-the-badge&logo=github&logoColor=white" alt="DetailedTM Repository" />
</a>
...
I believe businesses should have more control over their digital tools.

That means building systems that are practical, understandable, maintainable, and not unnecessarily locked behind platforms or templates.
